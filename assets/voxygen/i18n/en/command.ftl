...
command-plot_trust-desc = Grant a player build access to your plot.
command-plot_untrust-desc = Revoke a player's build access to your plot.
...
command-plot_trust-self = You cannot trust yourself on your own plot.
command-plot_trust-granted = Granted build access to { $player } on your plot.
command-plot_trust-trustee-notified = { $owner } has granted you build access to their plot.
command-plot_untrust-not-trusted = { $player } does not have build access to your plot.
command-plot_untrust-revoked = Revoked build access from { $player }.
