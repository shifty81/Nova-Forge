...
hud-settings-show_chat_timestamp = Show Timestamps in Chat
...
hud-settings-sfx_channels_low = Low
hud-settings-sfx_channels_med = Medium
hud-settings-sfx_channels_high = High
